        ...
        >
          ...
          >
            ...
            <div className="flex items-center px-4 py-3 border-b border-slate-200/80 dark:border-white/10 gap-3">
              ...
              <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded">
                ESC
              </kbd>
            </div>
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                  {item.priority && (
                                    <span className="flex items-center gap-1 text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold">
                                      <Flame
                                        className={cn(
                                          "w-3 h-3",
            ...
            {/* Footer Bar */}
            <div className="px-4 py-2 border-t border-slate-200/80 dark:border-white/10 bg-slate-50/50 dark:bg-white/2 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400">
