                    ...
                    {can("CREATE_MOU", mou.branchId) && (
                      <button
                        ...
                        onClick={(e) => {
                          ...
                          setModalMou({
                            branchId: mou.branchId,
                            outletId: mou.outletId,
                            outletName: mou.outletName,
                            partnerName: mou.partnerName,
                            mouType: mou.mouType,
                            startDate: new Date().toISOString().slice(0, 10),
                            endDate: "",
                            picName: mou.picName,
                            picPhone: mou.picPhone,
                            compensationValue: mou.compensationValue,
                            notes: `Perpanjangan (Renewal) dari MOU ${mou.partnerName} (berakhir ${mou.endDate?.slice(0, 10)})`,
                            status: "DRAFT",
                          });
                        }}
