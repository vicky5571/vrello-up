...
import { PLATFORM_CONFIG, DEFAULT_POST_SUBTASKS } from "./contentConstants";
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <ContentPostModal
        ...
        onTargetSpaceChange={handleTargetSpaceChange}
          ...
          openSelector({
            ...
            onSelect: (atts) => {
              if (atts[0]) {
                ...
                toast.success(
                  "Tautan Google Drive berhasil disematkan ke postingan"
                );
              }
            },
          })
