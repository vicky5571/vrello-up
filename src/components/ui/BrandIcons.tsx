...
import { PenLine, Newspaper, Globe } from "lucide-react";
...
export function BlogIcon({ className = "w-4 h-4" }: { className?: string }) {
  return <PenLine className={className} />;
}

export function PressIcon({ className = "w-4 h-4" }: { className?: string }) {
